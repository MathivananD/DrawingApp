...
class DrawingView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private var mBrushSize: Float = 14.toFloat()
   ...
   fun undo(){
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        Log.d("qqqqqqq onSizeChanged", "Called")
        super.onSizeChanged(w, h, oldw, oldh)

        mCanvasBitmap = createBitmap(w, h, Bitmap.Config.ARGB_8888)
    ...
    internal fun setSize(newSize: Float) {
